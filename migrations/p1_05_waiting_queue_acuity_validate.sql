...
-- Asserts that waiting_queue has all new features, policies, constraints, and RLS.
-- ============================================================================
DO $$
BEGIN
    ...
    -- 2. Assert RLS is enabled and forced
    IF NOT EXISTS (
    ...
    -- 3. Assert canonical tenant isolation policy exists
    IF NOT EXISTS (
    ...
    -- 4. Assert check constraint exists
    IF NOT EXISTS (
    ...
    -- 5. Assert tenant_id FK to tenants exists
    IF NOT EXISTS (
